...
import SquadFlowLogo from "../../public/logo-color.png";
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-green-900 text-white py-16 px-6">
      ...
      <div className="text-lg md:text-xl lg:text-2xl text-neutral-300 max-w-3xl text-center mx-auto mb-12">
        Our intuitive boards, lists, and cards help you organize ideas
        effortlessly. Integrate your favorite apps and work seamlessly online or
        offline with SquadFlow.
      </div>

      <Button className="bg-lime-500 hover:bg-lime-600" size="lg" asChild>
        <Link href="/sign-up">Get Started SquadFlow for Free</Link>
      </Button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-neutral-700">
              Effortlessly create boards, lists, and cards to visualize and
              organize your ideas.
            </p>
          </div>
          {/* Feature 2 */}
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="text-neutral-700">
              Work seamlessly even when offline. Access your tasks and projects
              anytime, anywhere.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <blockquote className="text-neutral-700 italic">
              "SquadFlow has transformed the way our team collaborates. The
              intuitive interface and powerful features make it a must-have for
              any project."
            </blockquote>
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <blockquote className="text-neutral-700 italic">
              "The offline access feature has been a game-changer for us. We can
              keep working, no matter where we are or whether we have an
              internet connection."
            </blockquote>
          ...
          <div className="p-6 bg-white rounded-lg shadow-md">
            <blockquote className="text-neutral-700 italic">
              "I love how SquadFlow integrates with our existing tools. It has
              made our workflow more efficient and saved us a lot of time."
            </blockquote>
